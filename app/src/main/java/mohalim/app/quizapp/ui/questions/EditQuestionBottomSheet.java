...
import mohalim.app.quizapp.databinding.BottomEditQuestionBinding;

public class EditQuestionBottomSheet extends BottomSheetDialogFragment implements HasAndroidInjector {
    @Inject
    ...
    private BottomEditQuestionBinding binding;
    QuestionsViewModel mViewModel;
    private int formError;
    QuizItem quizItem;
    QuestionItem oldQuestionItem;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = BottomEditQuestionBinding.inflate(inflater, container, false);
        ...
        binding.setQuestion(oldQuestionItem);
    ...
    private void initView() {
        ...
        binding.answerEt1.setError(null);
        binding.answerEt2.setError(null);
        binding.answerEt3.setError(null);
        binding.answerEt4.setError(null);
        binding.answerEt5.setError(null);
        ...
        binding.submitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                QuestionItem questionItem = oldQuestionItem;
                ...
                mViewModel.startUpdateQuestion(quizItem, questionItem);
                onUpdateQuestion.onUpdateQuestion();
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            onUpdateQuestion = (OnUpdateQuestion) context;
        }catch (ClassCastException e){
            throw new ClassCastException("Activity must implement OnUpdateQuestion class \n"+e.getMessage());
        }

    }

    public void setOldQuestionItem(QuestionItem questionItem) {
        this.oldQuestionItem = questionItem;
    }
    ...
    public interface OnUpdateQuestion{
